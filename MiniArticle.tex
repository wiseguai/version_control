...
\title{Mini-Article\tnoteref{t1}
}
\tnotetext[t1]{This document was created using an existing template for Elsevier journal articles. Changes to this document are committed to GitHub through GitKraken.}
\author[1]{Ian Wise}
